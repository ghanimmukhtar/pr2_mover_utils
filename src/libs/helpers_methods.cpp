...
void pr2_helpers_methods::locate_eef_pose(geometry_msgs::Pose &eef_feedback, Data_config& parameters, const std::string gripper){
...
void pr2_helpers_methods::prepare_motion_request(pr2_mover_utils::move_pr2_arm::Request &req,
